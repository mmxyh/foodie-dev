...
public class ItemServiceImpl implements ItemService {
    ...
    public List<ItemsImg> queryItemImgList(String itemId) {
        ...
        // itemId要与ItemsImg.class的itemId字段匹配
    ...
    public void decreaseItemSpecStockById(String specId, int buyCounts) {
         ...
         *
         *
         * ps： [共享资源数据一致性] 由于库存属于共享资源，先查询后扣除，当多个用户同时操作时可能会出现复数 10 - 4 - 3 - 5 = -2
         *
         * 思路1： synchronized，仅适用于单体架构，集群下无用，且性能低下，不推荐
         * 思路2： 锁数据库，导致数据库性能低下，不推荐
         * 思路3： 分布式锁 zookeeper redis 推荐
         * 思路4: 乐观锁, 适用于单体架构
         */
...
//        }
        ...
        // 单体架构情况下，处理减库存业务，使用乐观锁机制（where 条件中增加 stock >= buyCounts，保证库存大于所买数量)
